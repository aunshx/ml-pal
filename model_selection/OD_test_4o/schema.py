...
with open('OD_task/OD_models_overview.json', 'r') as infile:
...
with open('OD_test_4o/OD_transformed_schema', 'w') as outfile:
    json.dump(transformed_models, outfile, indent=4)

print("Combined transformed schema saved to LLM_models_transformed.json")
